...
import static Helpers.Helper.getArrayFromUser;
...
public class InsertSort {
    ...
    private static int[] doInsertSort(int[] arrayN) {
    ...
    private static int[] move(int[] arrayResult, int insertValue, int insertIndex) {
